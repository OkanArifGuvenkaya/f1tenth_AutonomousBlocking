...
class FollowTheGapNode(Node):
    def __init__(self):
        ...
        self.declare_parameter('smoothing_filter_size', 7)
        self.declare_parameter('truncated_coverage_angle', 160.0)
        self.declare_parameter('max_accepted_distance', 6.0)
        self.declare_parameter('error_based_velocities.low', 1.4)
        self.declare_parameter('error_based_velocities.medium', 0.8)
        self.declare_parameter('error_based_velocities.high', 0.6)
        self.declare_parameter('steering_angle_reactivity', 0.5)
