...
class StanleyAvoidance(Node):
    def __init__(self):
        ...
        self.declare_parameter("waypoints_path", "/home/f1tenth/lab_ws25/src/stanley_avoidance/racelines/FTM_clean_ws25.csv")
        self.declare_parameter("waypoints_path_2nd", "/home/f1tenth/lab_ws25/src/stanley_avoidance/racelines/FTM_clean_ws25.csv")
        ...
        self.declare_parameter("K_H", 0.1)
        self.declare_parameter("crosstrack_error_offset", 0.0)
        self.declare_parameter("min_lookahead", 0.6)
        self.declare_parameter("max_lookahead", 1.0)
        self.declare_parameter("min_lookahead_speed", 0.2)
        self.declare_parameter("max_lookahead_speed", 0.3)
        self.declare_parameter("interpolation_distance", 0.05)
        self.declare_parameter("velocity_min", 0.2)
        self.declare_parameter("velocity_max", 0.3)
